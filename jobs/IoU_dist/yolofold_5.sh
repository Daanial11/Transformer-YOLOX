...
python evaluate.py gpus='0,1,2,3' backbone="Yolo-l" load_model="~/scratch/weights/m_yolo_f5.pth" test_ann="~/scratch/TACO/fold5/instances_val2017.json" test_size=[640,640]
