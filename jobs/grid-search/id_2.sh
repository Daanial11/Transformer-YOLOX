...
python train.py gpus='0,1,2,3' backbone="Swin-l" num_epochs=10 exp_id="grid2" fold=1 use_amp=True val_intervals=2 data_num_workers=14 basic_lr_per_img=0.0001 batch_size=2 freeze_backbone=True use_amp=True random_size=[14,26] input_size=[640,640] test_size=[640,640] load_model="exp/Swin_l_pretrained_yolo_l/model_50.pth"
