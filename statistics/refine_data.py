...
for fold in range(1, 6):
    ...
    result_file_path = f'data/results_{m_o}/result_{m_o}_{model}_f{fold}.json'
    ann_path = f'data/annotations/{m_o}/fold{fold}.json'
    ...
    with open(f"data/iou_data_{m_o}/iou_{model}_f{fold}.json", 'w') as out:
        json.dump(preds_per_image_highest, out)
